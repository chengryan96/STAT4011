...
colnames(timeage_df) = c('date', 'a0s', 'a10s', 'a20s', 'a30s', 'a40s', 'a50s', 'a60s', 'a70s', 'a80s')
...
colnames(time_non_cumu) = c('date', 'a0s', 'a10s', 'a20s', 'a30s', 'a40s', 'a50s', 'a60s', 'a70s', 'a80s')
```
...
colnames(timeage_death_df) = c('date', 'a0s', 'a10s', 'a20s', 'a30s', 'a40s', 'a50s', 'a60s', 'a70s', 'a80s')
...
colnames(time_death_non_cumu) = c('date', 'a0s', 'a10s', 'a20s', 'a30s', 'a40s', 'a50s', 'a60s', 'a70s', 'a80s')
```
...
colnames(timegen_confirm_noncumu_df) = c('date', 'female', 'male')
```
...
colnames(timegen_death_noncumu_df) = c('date', 'female', 'male')
```
